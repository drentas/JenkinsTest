...
class __TwigTemplate_4e514c1c7bf0d6f19389163ceee5085944b0b3c26b13bbe36b6b172e8f249718 extends Twig_Template
{
    ...
    {
        // line 3
        $context["__internal_cf5dfbea68b923ad357c264060a57f677b4e4ccad6557a7c6db975e49069aad2"] = $this;
    ...
    ";
        ...
        if (twig_length_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "data"), "forms"))) {
            ...
            foreach ($context['_seq'] as $context["formName"] => $context["formData"]) {
                // line 188
                echo "                    ";
                echo $context["__internal_cf5dfbea68b923ad357c264060a57f677b4e4ccad6557a7c6db975e49069aad2"]->getform_tree_entry($this->getContext($context, "formName"), $this->getContext($context, "formData"), true);
                echo "
                ";
            }
            ...
            foreach ($context['_seq'] as $context["formName"] => $context["formData"]) {
                // line 194
                echo "                ";
                echo $context["__internal_cf5dfbea68b923ad357c264060a57f677b4e4ccad6557a7c6db975e49069aad2"]->getform_tree_details($this->getContext($context, "formName"), $this->getContext($context, "formData"), $this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "data"), "forms_by_hash"));
                echo "
            ";
            }
            $_parent = $context['_parent'];
